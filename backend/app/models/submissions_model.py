...
class Submission(Base):
    ...
    # --- relationships ---
    student = relationship("User", foreign_keys=[student_id], back_populates="submissions_made")
    graded_by = relationship("User", foreign_keys=[graded_by_id], back_populates="submissions_graded")
